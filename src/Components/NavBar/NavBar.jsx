...
const Bars = ({ onClick, showMenu }) => {
    return (
        <div
            className={showMenu ? `${styles.nav_btn} ${styles.open}` : `${styles.nav_btn}`}
            onClick={onClick}
        >
            <div className={styles.nav_btn_burger}></div>
        </div>
    )
}
...
const NavBar = () => {
    ...
    return (
        <Fragment>
            <div className={!showMenu ? `${styles.fullpageNav}`: `${styles.fullpageNav} ${styles.active}`}>
